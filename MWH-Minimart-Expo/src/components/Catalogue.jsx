...
const Catalogue = () => {
  ...
  return (
    <Box flex={1} backgroundColor="$gray50">
      <Header />
      <HStack alignItems="flex-start" justifyContent="flex-start" px="$8" py="$6" space="$8">
        <Sidebar 
        ...
        <VStack flex={1} space="$6">
          {/* Controls Section */}
          <HStack alignItems="center" justifyContent="flex-end" mb="$6" space="$4">
            <Input
              borderRadius="$full"
              borderColor="$gray300"
            ...
            <HStack space="$2">
              ...
              >
                <ButtonText color="$gray800" fontWeight="$semibold">Point ascending</ButtonText>
              </Button>
              <Button
              ...
              >
                <ButtonText color="$gray800" fontWeight="$semibold">Points descending</ButtonText>
              </Button>
            </HStack>
          </HStack>
          {/* Product Grid */}
